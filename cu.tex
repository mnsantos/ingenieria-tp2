...
\cu{Registrando usuario}{Usuario}{}
...
\begin{center}
    ...
    \begin{tabular}{ | p{11cm} | p{6cm} | }
		...
		por el usuario: Nombre completo, Número de DNI, Domicilio y un teléfono
...
\cu{Consultando stock/tiempo}{Usuario}{Usuario registrado}
\begin{center}
    \centering
    \begin{tabular}{ | p{11cm} | p{6cm} | }
    	\multicolumn{1}{c}{\cellcolor{black!30}\textbf{Curso normal}} & 
...
\cu{Agregando sugerencia}{Usuario}{Usuario registrado}
\begin{center}
    \centering
    \begin{tabular}{ | p{11cm} | p{6cm} | }
    	\multicolumn{1}{c}{\cellcolor{black!30}\textbf{Curso normal}} & 
